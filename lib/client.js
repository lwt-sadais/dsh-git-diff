window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function filterRepositoryTree(repository, query) {
			if (query.trim() === "") return repository;
			const files = repository.files.filter((file) => fuzzyPathMatch(file.path, query));
			const children = repository.children.map((child) => filterRepositoryTree(child, query)).filter((child) => child.files.length > 0 || child.children.length > 0);
			return {
				...repository,
				files,
				children
		...
		function visibleRowRange(rowCount, scrollTop, viewportHeight) {
			const boundedCount = Math.max(0, rowCount);
			const windowSize = Math.ceil(Math.max(0, viewportHeight) / 20) + 40;
			const requestedStart = Math.max(0, Math.floor(Math.max(0, scrollTop) / 20) - OVERSCAN_ROWS);
			const start = Math.min(requestedStart, Math.max(0, boundedCount - windowSize));
			return {
				start,
				end: Math.min(boundedCount, start + windowSize)
			};
		}
		//#endregion
		...
		function allRepositoryPaths(repository) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							position: "absolute",
							inset: `${range.start * 20}px 0 auto 0`
						},
		...
		function GitDiffDock(props) {
			...
			const [manifestId, setManifestId] = (0, react.useState)(null);
			const [fileDetails, setFileDetails] = (0, react.useState)(/* @__PURE__ */ new Map());
			const [fileLoading, setFileLoading] = (0, react.useState)(false);
			const [fileError, setFileError] = (0, react.useState)(null);
			const [query, setQuery] = (0, react.useState)("");
			const [sidebarWidth, setSidebarWidth] = (0, react.useState)(250);
			...
			const loadController = (0, react.useRef)(null);
			const loadRequestId = (0, react.useRef)(0);
			const fileController = (0, react.useRef)(null);
			const fileRequestId = (0, react.useRef)(0);
			const filteredRepository = (0, react.useMemo)(() => repository === null ? null : filterRepositoryTree(repository, query), [query, repository]);
			const filteredPaths = (0, react.useMemo)(() => new Set(query.trim() === "" ? files.map((file) => file.path) : files.filter((file) => fuzzyPathMatch(file.path, query)).map((file) => file.path)), [files, query]);
			const activeSummary = (0, react.useMemo)(() => {
				return files.find((file) => file.path === activePath && filteredPaths.has(file.path)) ?? files.find((file) => filteredPaths.has(file.path));
			}, [
				activePath,
				files,
				filteredPaths
			]);
			const activeFile = activeSummary === void 0 ? void 0 : fileDetails.get(activeSummary.id);
			const load = (0, react.useCallback)(async () => {
				...
				try {
					...
					if (!result.ok) setError(result.error.message);
						...
						setFileDetails(/* @__PURE__ */ new Map());
						setFileError(null);
					...
					if (!(cause instanceof DOMException && cause.name === "AbortError") && requestId === loadRequestId.current) setError(cause instanceof Error ? cause.message : "Git diff service is unavailable");
				} finally {
			...
			(0, react.useEffect)(() => {
				if (!open || cwd === void 0 || cwd === "" || manifestId === null || activeSummary === void 0 || fileDetails.has(activeSummary.id)) return;
				...
				readDiffFile({
					...
					if (!(cause instanceof DOMException && cause.name === "AbortError") && requestId === fileRequestId.current) setFileError(cause instanceof Error ? cause.message : "Git diff service is unavailable");
				}).finally(() => {
			...
			const beginSidebarResize = (event) => {
				...
				const move = (moveEvent) => setSidebarWidth(Math.min(520, Math.max(180, startWidth + moveEvent.clientX - startX)));
				const finish = () => {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							"aria-hidden": "true",
							style: { "--dgd-icon-mask": `url(${gitDiffToolbarIcon})` }
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
										...
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												className: "dgdFileSearch",
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "dgdSearchIcon",
														"aria-hidden": "true",
														children: "⌕"
													}),
											...
											filteredRepository !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RepositoryTree, {
											...
											query.trim() !== "" && filteredPaths.size === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: "dgdNoMatches",
												children: t("noMatches")
											})
										]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: "dgdSidebarResize",
										role: "separator",
										"aria-orientation": "vertical",
										"aria-label": t("resizeFileList"),
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
										...
										children: [loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											...
											role: "alert",
											children: error
										}) : activeSummary === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: "dgdCenter",
											children: t("empty")
										}) : fileLoading ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectedFileHeader, {
											file: activeSummary,
											t
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: "dgdCenter",
											children: t("loading")
										})] }) : fileError !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectedFileHeader, {
											file: activeSummary,
											t
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: "dgdCenter",
